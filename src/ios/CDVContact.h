...
#define kW3ContactPhoneHomeFaxLabel @"homeFax"
#define kW3ContactPhoneWorkFaxLabel @"workFax"
...
#define kW3ContactImFacebookMessengerLabel @"facebookMessenger"
#define kW3ContactImGoogleTalkLabel @"googleTalk"
#define kW3ContactImQQLabel @"qq"
#define kW3ContactImGaduGaduLabel @"gaduGadu"
...
#define kW3ContactSocialProfiles @"socialProfiles"
#define kW3ContactSocialFacebookLabel @"facebook"
#define kW3ContactSocialTwitterLabel @"twitter"
#define kW3ContactSocialLinkedInLabel @"linkedIn"
#define kW3ContactSocialFlickrLabel @"flickr"
#define kW3ContactSocialMyspaceLabel @"myspace"
#define kW3ContactSocialSinaWeiboLabel @"sinaWeibo"
#define kW3ContactSocialGameCenterLabel @"gameCenter"
// Social Profile types
#define kW3ContactSocialType @"type"
#define kW3ContactSocialValue @"value"
